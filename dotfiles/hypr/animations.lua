...
-- Spring Curves
hl.curve("spring_menu", { type = "spring", mass = 1, stiffness = 870, dampening = 55 })
hl.curve("spring_window", { type = "spring", mass = 1, stiffness = 870, dampening = 55 })
hl.curve("spring_open", { type = "spring", mass = 1, stiffness = 870, dampening = 55 })
hl.curve("spring_workspace", { type = "spring", mass = 1, stiffness = 870, dampening = 55 })
hl.curve("spring_special", { type = "spring", mass = 1, stiffness = 870, dampening = 55 })
